      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0 md:w-1/3">
            <h3 className="text-2xl font-bold mb-4">Alvaro<span className="text-blue-500">Delgado</span></h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Desarrollador web especializado en crear experiencias digitales únicas e innovadoras para mis clientes.
            </p>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">Contáctame</h4>
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-400 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">contacto@alvarodelgado.dev</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-400 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} Alvaro Delgado. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
